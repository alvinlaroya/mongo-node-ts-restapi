...
function createPostHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, body, post;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userId = lodash_1.get(req, "user._id");
                    body = req.body;
                    return [4 /*yield*/, post_service_1.createPost(__assign(__assign({}, body), { user: userId }))];
                case 1:
                    post = _a.sent();
...
function updatePostHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, postId, update, post, updatedPost;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userId = lodash_1.get(req, "user._id");
                    postId = lodash_1.get(req, "params.postId");
                    update = req.body;
                    return [4 /*yield*/, post_service_1.findPost({ postId: postId })];
                case 1:
                    post = _a.sent();
                    if (!post) {
                    ...
                    return [4 /*yield*/, post_service_1.findAndUpdate({ postId: postId }, update, { new: true })];
                case 2:
                    updatedPost = _a.sent();
                    return [2 /*return*/, res.send(updatedPost)];
            }
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, post_service_1.deletePost({ postId: postId })];
                case 2:
                    _a.sent();
